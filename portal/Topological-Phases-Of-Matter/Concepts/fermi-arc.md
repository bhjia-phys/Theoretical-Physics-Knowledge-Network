...
## Scope
Lecture One surface-state discussion connected to bulk Weyl nodes.
...
- `bridges_to` -> [Bulk-Boundary Correspondence To Fermi Arc](../Bridges/bulk-boundary-correspondence-to-fermi-arc.md): The boundary arc is connected to a bulk-boundary bridge object.
- `depends_on` -> [Weyl Node](weyl-node.md): Fermi arcs are boundary signatures of bulk Weyl-node topology.
